...
<div class="body">
	<div class="container-fluid">
		<div class="page-title">
			<h2 class="mb-0">
				<i class="fa fa-leaf fa-fw"></i> Sayur
			</h2>
			<div class="text-secondary mt-1 mb-1">@keroro</div>
		</div>
				...
				<div class="card mb-3">
					<ul class="list-group list-group-flush">
						<li class="list-group-item">
							<div class="media">
								...
								<div class="media-body">
									...
									<small class="text-secondary">30 0ktober 2017</small>
								</div>
							</div>
						</li>
						...
						<li class="list-group-item">
							...
							<small class="text-secondary">Category Resep</small>
						</li>
