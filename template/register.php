...
<div class="body">
	<div class="container-fluid">
		<div class="page-title">
			<h2>
				<i class="fa fa-user-plus fa-fw"></i> Daftar
			</h2>
		</div>
		<div class="page-content">
			<form class="mb-3">
				...
				<div class="form-group mt-4 mb-3">
					<button type="submit" class="btn btn-primary btn-block"><i class="fa fa-user-plus fa-fw"></i> Daftar</button>
				</div>
				<div class="form-group">
					<label>Sudah Memiliki Akun</label>
				</div>
				<div class="form-group mt-2">
					<button type="submit" class="btn btn-info btn-block"><i class="fa fa-sign-in fa-fw"></i> Masuk</button>
				</div>
			</form>
		</div>
	</div>
