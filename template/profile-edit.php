...
<div class="body">
	<div class="container-fluid">
		<div class="page-title">
			<h2>
				<i class="fa fa-fw fa-cog"></i> Seting Profil
			</h2>
		</div>
		<div class="page-content">
			<form class="mb-3">
				...
				<div class="form-group">
					...
					<input type="email" class="form-control" placeholder="Judul Resep" readonly="">
				</div>
				<div class="form-group mt-4">
					<button type="submit" class="btn btn-primary btn-block"><i class="fa fa-fw fa-cog"></i> Seting Profil</button>
				</div>
			</form>
		</div>
	</div>
