...
<div class="body">
	<div class="container-fluid">
		<div class="page-title">
			<h2>
				<i class="fa fa-plus-circle fa-fw"></i> Tambah Resep
			</h2>
		</div>
		<div class="page-content">
			<form class="mb-3">
				<div class="form-group">
					...
					<input type="email" class="form-control" placeholder="Judul Resep">
				</div>
				<div class="form-group">
					<label>Gambar</label>
				...
				<div class="form-group">
					<label>Bahan</label>
					<textarea class="form-control" placeholder="Bahan"></textarea>
					<small class="form-text text-muted">Pisahkan bahan dengan baris baru.</small>
				</div>
				<div class="form-group">
					<label>Langkah Memasak</label>
					<textarea class="form-control" placeholder="Langkah Memasak"></textarea>
					<small class="form-text text-muted">Pisahkan lankah dengan baris baru.</small>
				</div>
				<div class="form-group mt-4">
					<button type="submit" class="btn btn-primary btn-block"><i class="fa fa-plus-circle fa-fw"></i> Tambah Resep</button>
				</div>
			</form>
		</div>
	</div>
